...
public class MWDialog2 extends JDialog implements KeyListener
{
...
//	}
	...
	public MWDialog2(JFrame jf) 
	{
		...
		label1.setIcon(new ImageIcon("img\\PictogramDrawer\\girl.png"));
		label1.setBounds(83, 49, 96, 96);
		contentPanel.add(label1);
		
		JLabel label3 = new JLabel("");
		label3.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null, null, null, null));
		label3.setIcon(new ImageIcon("img\\PictogramDrawer\\boy.png"));
		...
		checkBox_2.setBounds(357, 167, 21, 23);
	...
	public boolean return0MWD2()
	{
		return checkBox_true;
	}
	public boolean return2MWD2()
	{
