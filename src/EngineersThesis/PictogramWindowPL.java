...
public class PictogramWindowPL extends JFrame 
{
	static PictogramWindowPL frame = new PictogramWindowPL();
	...
	private boolean sen_label_1_fill = false;
	private boolean sen_label_2_fill = false;
	private boolean sen_label_3_fill = false;
	private boolean sen_label_4_fill = false;
	private boolean sen_label_5_fill = false;
	private boolean sen_label_6_fill = false;
	private boolean sen_label_7_fill = false;
	private boolean sen_label_8_fill = false;
	private boolean sen_label_9_fill = false;
	...
	private ImageIcon tak;
	private ImageIcon bardzo;
	private ImageIcon czy;
	private ImageIcon moja;
	...
	private boolean pierwsza_osoba_l_p = false;
	private boolean druga_osoba_l_p = false;
	private boolean pierwsza_osoba_l_m = false;
	private boolean druga_osoba_l_m = false;
	private boolean trzecia_osoba_on = false;
	private boolean trzecia_osoba_ona = false;
	private boolean trzecia_osoba_ono = false;
	 ...
	 */
	public static void ShowPicogramWindowPL() 
	{
	...
	public void init()
	{
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		label_27.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if (sen_label_1_fill == false) {
			    	Sentence_label.setIcon(tak);				    	
			    	sen_label_1_fill = true;
			    }
			    else if (sen_label_2_fill == false) {
			    	Sentence_label_1.setIcon(tak);
			    	sen_label_2_fill = true;
			    }
			    else if (sen_label_3_fill == false) {
			    	Sentence_label_2.setIcon(tak);				    	
			    	sen_label_3_fill = true;
			    }
			    else if (sen_label_4_fill == false) {
			    	Sentence_label_3.setIcon(tak);
			    	sen_label_4_fill = true;
			    }
			    else if (sen_label_5_fill == false) {
			    	Sentence_label_4.setIcon(tak);				    	
			    	sen_label_5_fill = true;
			    }
			    else if (sen_label_6_fill == false) {
			    	Sentence_label_5.setIcon(tak);
			    	sen_label_6_fill = true;
			    }
			    else if (sen_label_7_fill == false) {
			    	Sentence_label_6.setIcon(tak);				    	
			    	sen_label_7_fill = true;
			    }
			    else if (sen_label_8_fill == false) {
			    	Sentence_label_7.setIcon(tak);
			    	sen_label_8_fill = true;
			    }
			    else if (sen_label_9_fill == false) {
			    	Sentence_label_8.setIcon(tak);
			    	sen_label_9_fill = true;
			    }
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
			Statement stmain = conmain.createStatement();
			ResultSet rsmain27 = stmain.executeQuery("select * from main where id = 4");			
			if (rsmain27.next())
			{
				byte[] img = rsmain27.getBytes("img");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
                Image myImg = im.getScaledInstance(80, 80,Image.SCALE_SMOOTH);
                ImageIcon newImage = new ImageIcon(myImg);
		...
		label_28.addMouseListener(new MouseAdapter() {
			...
			{
				if (sen_label_1_fill == false) {
			    	Sentence_label.setIcon(sa);				    	
			    	sen_label_1_fill = true;
			    }
			    else if (sen_label_2_fill == false) {
			    	Sentence_label_1.setIcon(sa);
			    	sen_label_2_fill = true;
			    }
			    else if (sen_label_3_fill == false) {
			    	Sentence_label_2.setIcon(sa);				    	
			    	sen_label_3_fill = true;
			    }
			    else if (sen_label_4_fill == false) {
			    	Sentence_label_3.setIcon(sa);
			    	sen_label_4_fill = true;
			    }
			    else if (sen_label_5_fill == false) {
			    	Sentence_label_4.setIcon(sa);				    	
			    	sen_label_5_fill = true;
			    }
			    else if (sen_label_6_fill == false) {
			    	Sentence_label_5.setIcon(sa);
			    	sen_label_6_fill = true;
			    }
			    else if (sen_label_7_fill == false) {
			    	Sentence_label_6.setIcon(sa);				    	
			    	sen_label_7_fill = true;
			    }
			    else if (sen_label_8_fill == false) {
			    	Sentence_label_7.setIcon(sa);
			    	sen_label_8_fill = true;
			    }
			    else if (sen_label_9_fill == false) {
			    	Sentence_label_8.setIcon(sa);
			    	sen_label_9_fill = true;
			    }
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
			Statement stmain = conmain.createStatement();
			ResultSet rsmain28 = stmain.executeQuery("select * from main where id = 5");			
			if (rsmain28.next())
			{
				byte[] img = rsmain28.getBytes("img");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
                Image myImg = im.getScaledInstance(80, 80,Image.SCALE_SMOOTH);
                ImageIcon newImage = new ImageIcon(myImg);
		...
		label_29.addMouseListener(new MouseAdapter() {
			...
			{
				if (sen_label_1_fill == false) {
			    	Sentence_label.setIcon(bardzo);				    	
			    	sen_label_1_fill = true;
			    }
			    else if (sen_label_2_fill == false) {
			    	Sentence_label_1.setIcon(bardzo);
			    	sen_label_2_fill = true;
			    }
			    else if (sen_label_3_fill == false) {
			    	Sentence_label_2.setIcon(bardzo);				    	
			    	sen_label_3_fill = true;
			    }
			    else if (sen_label_4_fill == false) {
			    	Sentence_label_3.setIcon(bardzo);
			    	sen_label_4_fill = true;
			    }
			    else if (sen_label_5_fill == false) {
			    	Sentence_label_4.setIcon(bardzo);				    	
			    	sen_label_5_fill = true;
			    }
			    else if (sen_label_6_fill == false) {
			    	Sentence_label_5.setIcon(bardzo);
			    	sen_label_6_fill = true;
			    }
			    else if (sen_label_7_fill == false) {
			    	Sentence_label_6.setIcon(bardzo);				    	
			    	sen_label_7_fill = true;
			    }
			    else if (sen_label_8_fill == false) {
			    	Sentence_label_7.setIcon(bardzo);
			    	sen_label_8_fill = true;
			    }
			    else if (sen_label_9_fill == false) {
			    	Sentence_label_8.setIcon(bardzo);
			    	sen_label_9_fill = true;
			    }
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
			Statement stmain = conmain.createStatement();
			ResultSet rsmain29 = stmain.executeQuery("select * from main where id = 6");			
			if (rsmain29.next())
			{
				byte[] img = rsmain29.getBytes("img");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
                Image myImg = im.getScaledInstance(80, 80,Image.SCALE_SMOOTH);
                ImageIcon newImage = new ImageIcon(myImg);
		...
		label_146.addMouseListener(new MouseAdapter() {
			...
			{
				if (sen_label_1_fill == false) {
			    	Sentence_label.setIcon(czy);				    	
			    	sen_label_1_fill = true;
			    }
			    else if (sen_label_2_fill == false) {
			    	Sentence_label_1.setIcon(czy);
			    	sen_label_2_fill = true;
			    }
			    else if (sen_label_3_fill == false) {
			    	Sentence_label_2.setIcon(czy);				    	
			    	sen_label_3_fill = true;
			    }
			    else if (sen_label_4_fill == false) {
			    	Sentence_label_3.setIcon(czy);
			    	sen_label_4_fill = true;
			    }
			    else if (sen_label_5_fill == false) {
			    	Sentence_label_4.setIcon(czy);				    	
			    	sen_label_5_fill = true;
			    }
			    else if (sen_label_6_fill == false) {
			    	Sentence_label_5.setIcon(czy);
			    	sen_label_6_fill = true;
			    }
			    else if (sen_label_7_fill == false) {
			    	Sentence_label_6.setIcon(czy);				    	
			    	sen_label_7_fill = true;
			    }
			    else if (sen_label_8_fill == false) {
			    	Sentence_label_7.setIcon(czy);
			    	sen_label_8_fill = true;
			    }
			    else if (sen_label_9_fill == false) {
			    	Sentence_label_8.setIcon(czy);
			    	sen_label_9_fill = true;
			    }
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
			Statement stmain = conmain.createStatement();
			ResultSet rsmain146 = stmain.executeQuery("select * from main where id = 7");			
			if (rsmain146.next())
			{
				byte[] img = rsmain146.getBytes("img");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
                Image myImg = im.getScaledInstance(80, 80,Image.SCALE_SMOOTH);
                ImageIcon newImage = new ImageIcon(myImg);
		...
		label_147.addMouseListener(new MouseAdapter() {
			...
			{
				if (sen_label_1_fill == false) {
			    	Sentence_label.setIcon(moja);				    	
			    	sen_label_1_fill = true;
			    }
			    else if (sen_label_2_fill == false) {
			    	Sentence_label_1.setIcon(moja);
			    	sen_label_2_fill = true;
			    }
			    else if (sen_label_3_fill == false) {
			    	Sentence_label_2.setIcon(moja);				    	
			    	sen_label_3_fill = true;
			    }
			    else if (sen_label_4_fill == false) {
			    	Sentence_label_3.setIcon(moja);
			    	sen_label_4_fill = true;
			    }
			    else if (sen_label_5_fill == false) {
			    	Sentence_label_4.setIcon(moja);				    	
			    	sen_label_5_fill = true;
			    }
			    else if (sen_label_6_fill == false) {
			    	Sentence_label_5.setIcon(moja);
			    	sen_label_6_fill = true;
			    }
			    else if (sen_label_7_fill == false) {
			    	Sentence_label_6.setIcon(moja);				    	
			    	sen_label_7_fill = true;
			    }
			    else if (sen_label_8_fill == false) {
			    	Sentence_label_7.setIcon(moja);
			    	sen_label_8_fill = true;
			    }
			    else if (sen_label_9_fill == false) {
			    	Sentence_label_8.setIcon(moja);
			    	sen_label_9_fill = true;
			    }
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
			Statement stmain = conmain.createStatement();
			ResultSet rsmain147 = stmain.executeQuery("select * from main where id = 8");			
			if (rsmain147.next())
			{
				byte[] img = rsmain147.getBytes("img");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
                Image myImg = im.getScaledInstance(80, 80,Image.SCALE_SMOOTH);
                ImageIcon newImage = new ImageIcon(myImg);
		...
		try 
		{
			Connection conmain = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
			Statement stmain = conmain.createStatement();
			ResultSet rsmain148 = stmain.executeQuery("select * from main where id = 9");			
			if (rsmain148.next())
			{
				byte[] img = rsmain148.getBytes("img");
                ImageIcon image = new ImageIcon(img);
                Image im = image.getImage();
                Image myImg = im.getScaledInstance(80, 80,Image.SCALE_SMOOTH);
                ImageIcon newImage = new ImageIcon(myImg);
		...
		try 
		{
			Connection conVerbs = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		label_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" PYTAM");
				if (druga_osoba_l_p)		setString(" PYTASZ");
				if (pierwsza_osoba_l_m)		setString(" PYTAMY");
				if (druga_osoba_l_m)		setString(" PYTACIE");
				if (trzecia_osoba_on)		setString(" PYTA");
				if (trzecia_osoba_ona)		setString(" PYTA");
				if (trzecia_osoba_ono)		setString(" PYTA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" PYTAÆ");
			}
		});
		...
		label_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" MOGÊ");
				if (druga_osoba_l_p)		setString(" MO¯ESZ");
				if (pierwsza_osoba_l_m)		setString(" MO¯EMY");
				if (druga_osoba_l_m)		setString(" MO¯ECIE");
				if (trzecia_osoba_on)		setString(" MO¯E");
				if (trzecia_osoba_ona)		setString(" MO¯E");
				if (trzecia_osoba_ono)		setString(" MO¯E");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" MÓC");
			}
		});
		...
		label_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" ZAMKNÊ");
				if (druga_osoba_l_p)		setString(" ZAMKNIESZ");
				if (pierwsza_osoba_l_m)		setString(" ZAMKNIEMY");
				if (druga_osoba_l_m)		setString(" ZAMKNIECIE");
				if (trzecia_osoba_on)		setString(" ZAMKNIE");
				if (trzecia_osoba_ona)		setString(" ZAMKNIE");
				if (trzecia_osoba_ono)		setString(" ZAMKNIE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" ZAMKN¥Æ");
			}
		});
		...
		label_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" PRZYJDÊ");
				if (druga_osoba_l_p)		setString(" PRZYJDZIESZ");
				if (pierwsza_osoba_l_m)		setString(" PRZYJDZIEMY");
				if (druga_osoba_l_m)		setString(" PRZYJDZIECIE");
				if (trzecia_osoba_on)		setString(" PRZYJDZIE");
				if (trzecia_osoba_ona)		setString(" PRZYJDZIE");
				if (trzecia_osoba_ono)		setString(" PRZYJDZIE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" PRZYJŒÆ");
			}
		});
		...
		label_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" ROBIÊ");
				if (druga_osoba_l_p)		setString(" ROBISZ");
				if (pierwsza_osoba_l_m)		setString(" ROBIMY");
				if (druga_osoba_l_m)		setString(" ROBICIE");
				if (trzecia_osoba_on)		setString(" ROBI");
				if (trzecia_osoba_ona)		setString(" ROBI");
				if (trzecia_osoba_ono)		setString(" ROBI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" ROBIÆ");
			}
		});
		...
		label_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" CZUJÊ");
				if (druga_osoba_l_p)		setString(" CZUJESZ");
				if (pierwsza_osoba_l_m)		setString(" CZUJEMY");
				if (druga_osoba_l_m)		setString(" CZUJECIE");
				if (trzecia_osoba_on)		setString(" CZUJE");
				if (trzecia_osoba_ona)		setString(" CZUJE");
				if (trzecia_osoba_ono)		setString(" CZUJE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" CZUÆ");
			}
		});
		...
		label_7.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" SZUKAM");
				if (druga_osoba_l_p)		setString(" SZUKASZ");
				if (pierwsza_osoba_l_m)		setString(" SZUKAMY");
				if (druga_osoba_l_m)		setString(" SZUKACIE");
				if (trzecia_osoba_on)		setString(" SZUKA");
				if (trzecia_osoba_ona)		setString(" SZUKA");
				if (trzecia_osoba_ono)		setString(" SZUKA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" SZUKAÆ");
			}
		});
		...
		label_8.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" DOSTA£EM");
				if (druga_osoba_l_p)		setString(" DOSTA£EŒ");
				if (pierwsza_osoba_l_m)		setString(" DOSTALIŒMY");
				if (druga_osoba_l_m)		setString(" DOSTALIŒCIE");
				if (trzecia_osoba_on)		setString(" DOSTA£");
				if (trzecia_osoba_ona)		setString(" DOSTA£A");
				if (trzecia_osoba_ono)		setString(" DOSTA£O");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" DOSTAÆ");
			}
		});
		...
		label_9.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" DA£EM");
				if (druga_osoba_l_p)		setString(" DA£EŒ");
				if (pierwsza_osoba_l_m)		setString(" DALIŒMY");
				if (druga_osoba_l_m)		setString(" DALIŒCIE");
				if (trzecia_osoba_on)		setString(" DA£");
				if (trzecia_osoba_ona)		setString(" DA£A");
				if (trzecia_osoba_ono)		setString(" DA£O");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" DAÆ");
			}
		});
		...
		label_10.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" IDÊ");
				if (druga_osoba_l_p)		setString(" IDZIESZ");
				if (pierwsza_osoba_l_m)		setString(" IDZIEMY");
				if (druga_osoba_l_m)		setString(" IDZIECIE");
				if (trzecia_osoba_on)		setString(" IDZIE");
				if (trzecia_osoba_ona)		setString(" IDZIE");
				if (trzecia_osoba_ono)		setString(" IDZIE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" IŒÆ");
			}
		});
		...
		label_11.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" MAM");
				if (druga_osoba_l_p)		setString(" MASZ");
				if (pierwsza_osoba_l_m)		setString(" MAMY");
				if (druga_osoba_l_m)		setString(" MACIE");
				if (trzecia_osoba_on)		setString(" MA");
				if (trzecia_osoba_ona)		setString(" MA");
				if (trzecia_osoba_ono)		setString(" MA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" MIEÆ");
			}
		});
		...
		label_13.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" WIEM");
				if (druga_osoba_l_p)		setString(" WIESZ");
				if (pierwsza_osoba_l_m)		setString(" WIEMY");
				if (druga_osoba_l_m)		setString(" WIECIE");
				if (trzecia_osoba_on)		setString(" WIE");
				if (trzecia_osoba_ona)		setString(" WIE");
				if (trzecia_osoba_ono)		setString(" WIE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" WIEDZIEÆ");
			}
		});
		...
		label_14.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" WYCHODZÊ");
				if (druga_osoba_l_p)		setString(" WYCHODZISZ");
				if (pierwsza_osoba_l_m)		setString(" WYCHODZIMY");
				if (druga_osoba_l_m)		setString(" WYCHODZICIE");
				if (trzecia_osoba_on)		setString(" WYCHODZI");
				if (trzecia_osoba_ona)		setString(" WYCHODZI");
				if (trzecia_osoba_ono)		setString(" WYCHODZI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" WYJŒÆ");
			}
		});
		...
		label_15.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" WIDZÊ");
				if (druga_osoba_l_p)		setString(" WIDZISZ");
				if (pierwsza_osoba_l_m)		setString(" WIDZIMY");
				if (druga_osoba_l_m)		setString(" WIDZICIE");
				if (trzecia_osoba_on)		setString(" WIDZI");
				if (trzecia_osoba_ona)		setString(" WIDZI");
				if (trzecia_osoba_ono)		setString(" WIDZI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" WIDZIEÆ");
			}
		});
		...
		label_16.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" ZROBIÊ");
				if (druga_osoba_l_p)		setString(" ZROBISZ");
				if (pierwsza_osoba_l_m)		setString(" ZROBIMY");
				if (druga_osoba_l_m)		setString(" ZROBICIE");
				if (trzecia_osoba_on)		setString(" ZROBI");
				if (trzecia_osoba_ona)		setString(" ZROBI");
				if (trzecia_osoba_ono)		setString(" ZROBI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" ZROBIÆ");
			}
		});
		...
		label_17.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" OTWIERAM");
				if (druga_osoba_l_p)		setString(" OTWIERASZ");
				if (pierwsza_osoba_l_m)		setString(" OTWIERAMY");
				if (druga_osoba_l_m)		setString(" OTWIERACIE");
				if (trzecia_osoba_on)		setString(" OTWIERA");
				if (trzecia_osoba_ona)		setString(" OTWIERA");
				if (trzecia_osoba_ono)		setString(" OTWIERA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" OTWORZYÆ");
			}
		});
		...
		label_18.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" GRAM");
				if (druga_osoba_l_p)		setString(" GRASZ");
				if (pierwsza_osoba_l_m)		setString(" GRAMY");
				if (druga_osoba_l_m)		setString(" GRACIE");
				if (trzecia_osoba_on)		setString(" GRA");
				if (trzecia_osoba_ona)		setString(" GRA");
				if (trzecia_osoba_ono)		setString(" GRA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" GRAÆ");
			}
		});
		...
		label_19.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" MÓWIÊ");
				if (druga_osoba_l_p)		setString(" MÓWISZ");
				if (pierwsza_osoba_l_m)		setString(" MÓWIMY");
				if (druga_osoba_l_m)		setString(" MÓWICIE");
				if (trzecia_osoba_on)		setString(" MÓWI");
				if (trzecia_osoba_ona)		setString(" MÓWI");
				if (trzecia_osoba_ono)		setString(" MÓWI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" MÓWIÆ");
			}
		});
		...
		label_20.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" PATRZÊ");
				if (druga_osoba_l_p)		setString(" PATRZYSZ");
				if (pierwsza_osoba_l_m)		setString(" PATRZYMY");
				if (druga_osoba_l_m)		setString(" PATRZYCIE");
				if (trzecia_osoba_on)		setString(" PATRZY");
				if (trzecia_osoba_ona)		setString(" PATRZY");
				if (trzecia_osoba_ono)		setString(" PATRZY");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" PATRZYÆ");
			}
		});
		...
		label_21.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" WZI¥£EM");
				if (druga_osoba_l_p)		setString(" WZI¥£EŒ");
				if (pierwsza_osoba_l_m)		setString(" WZIÊLIŒMY");
				if (druga_osoba_l_m)		setString(" WZIÊLIŒCIE");
				if (trzecia_osoba_on)		setString(" WZI¥£");
				if (trzecia_osoba_ona)		setString(" WZIÊ£A");
				if (trzecia_osoba_ono)		setString(" WZIÊ£O");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" WZI¥Æ");
			}
		});
		...
		label_22.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" ROZMAWIAM");
				if (druga_osoba_l_p)		setString(" ROZMAWIASZ");
				if (pierwsza_osoba_l_m)		setString(" ROZMAWIAMY");
				if (druga_osoba_l_m)		setString(" ROZMAWIACIE");
				if (trzecia_osoba_on)		setString(" ROZMAWIA");
				if (trzecia_osoba_ona)		setString(" ROZMAWIA");
				if (trzecia_osoba_ono)		setString(" ROZMAWIA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" ROZMAWIAÆ");
			}
		});
		...
		label_23.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" MYŒLÊ");
				if (druga_osoba_l_p)		setString(" MYŒLISZ");
				if (pierwsza_osoba_l_m)		setString(" MYŒLIMY");
				if (druga_osoba_l_m)		setString(" MYŒLICIE");
				if (trzecia_osoba_on)		setString(" MYŒLI");
				if (trzecia_osoba_ona)		setString(" MYŒLI");
				if (trzecia_osoba_ono)		setString(" MYŒLI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" MYŒLEÆ");
			}
		});
		...
		label_143.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" PRÓBUJE");
				if (druga_osoba_l_p)		setString(" PRÓBUJESZ");
				if (pierwsza_osoba_l_m)		setString(" PRÓBUJEMY");
				if (druga_osoba_l_m)		setString(" PRÓBUJECIE");
				if (trzecia_osoba_on)		setString(" PRÓBUJE");
				if (trzecia_osoba_ona)		setString(" PRÓBUJE");
				if (trzecia_osoba_ono)		setString(" PRÓBUJE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" PRÓBOWAÆ");
			}
		});
		...
		label_144.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" U¯YWAM");
				if (druga_osoba_l_p)		setString(" U¯YWASZ");
				if (pierwsza_osoba_l_m)		setString(" U¯YWAMY");
				if (druga_osoba_l_m)		setString(" U¯YWACIE");
				if (trzecia_osoba_on)		setString(" U¯YWA");
				if (trzecia_osoba_ona)		setString(" U¯YWA");
				if (trzecia_osoba_ono)		setString(" U¯YWA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" U¯YÆ");
			}
		});
		...
		label_145.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" CHCÊ");
				if (druga_osoba_l_p)		setString(" CHCESZ");
				if (pierwsza_osoba_l_m)		setString(" CHCEMY");
				if (druga_osoba_l_m)		setString(" CHCECIE");
				if (trzecia_osoba_on)		setString(" CHCE");
				if (trzecia_osoba_ona)		setString(" CHCE");
				if (trzecia_osoba_ono)		setString(" CHCE");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" CHCIEÆ");
			}
		});
		...
		try 
		{
			Connection conPeople = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		try 
		{
			Connection conAdjectives = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		try 
		{
			Connection conPrepositions = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		try 
		{
			Connection conFeelings = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		label_87.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" LUBIÊ");
				if (druga_osoba_l_p)		setString(" LUBISZ");
				if (pierwsza_osoba_l_m)		setString(" LUBIMY");
				if (druga_osoba_l_m)		setString(" LUBICIE");
				if (trzecia_osoba_on)		setString(" LUBI");
				if (trzecia_osoba_ona)		setString(" LUBI");
				if (trzecia_osoba_ono)		setString(" LUBI");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" LUBIÆ");
			}
		});
		...
		label_88.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (pierwsza_osoba_l_p)		setString(" KOCHAM");
				if (druga_osoba_l_p)		setString(" KOCHASZ");
				if (pierwsza_osoba_l_m)		setString(" KOCHAMY");
				if (druga_osoba_l_m)		setString(" KOCHACIE");
				if (trzecia_osoba_on)		setString(" KOCHA");
				if (trzecia_osoba_ona)		setString(" KOCHA");
				if (trzecia_osoba_ono)		setString(" KOCHA");
				if (!pierwsza_osoba_l_p && !druga_osoba_l_p && !pierwsza_osoba_l_m && !druga_osoba_l_m && !trzecia_osoba_on && !trzecia_osoba_ona && !trzecia_osoba_ono) setString(" KOCHAÆ");
			}
		});
		...
		try 
		{
			Connection conBody = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		try 
		{
			Connection conAnimal = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		try 
		{
			Connection conRoom = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		try 
		{
			Connection conThings = DriverManager.getConnection("jdbc:mysql://localhost/projekt_inzynierski_pl","root","");
		...
		pupup_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				pierwsza_osoba_l_p = false;
				druga_osoba_l_p = false;
				pierwsza_osoba_l_m = false;
				druga_osoba_l_m = false;
				trzecia_osoba_on = false;
				trzecia_osoba_ona = false;
				trzecia_osoba_ono = false;
				
				if (menuclass == null)
				{
					menuclass = new MenuClass(PictogramWindowPL.this);
				}
	...
	public void connection() throws IOException
	{
		String name = "MAIN";
		int sourcePort = 5555;
		String destinationIP = "192.168.1.17";
		int destinationPort = 1111;
		...
		while (true) 
		{
			channel.sendMessage(address, string);
			channel.stop();
		}			
	}
}