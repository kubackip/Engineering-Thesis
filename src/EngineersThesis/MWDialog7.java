...
public class MWDialog7 extends JDialog implements KeyListener
{
...
//	}
	...
	public MWDialog7(JFrame jf) 
	{
		...
		label1.setIcon(new ImageIcon("img\\PictogramDrawer\\bathroom.png"));
		label1.setBounds(83, 49, 96, 96);
		contentPanel.add(label1);
		
		JLabel label3 = new JLabel("");
		label3.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null, null, null, null));
		label3.setIcon(new ImageIcon("img\\PictogramDrawer\\toilet.png"));
	...
	public boolean return0MWD7()
	{
		return checkBox_true;
	}
	public boolean return2MWD7()
	{
