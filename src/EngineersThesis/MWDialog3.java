...
public class MWDialog3 extends JDialog implements KeyListener
{
...
//	}
	...
	public MWDialog3(JFrame jf) 
	{
		...
		label1.setIcon(new ImageIcon("img\\PictogramDrawer\\Grandma.png"));
		label1.setBounds(83, 49, 96, 96);
		contentPanel.add(label1);
		
		JLabel label3 = new JLabel("");
		label3.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null, null, null, null));
		label3.setIcon(new ImageIcon("img\\PictogramDrawer\\Grandpa.png"));
	...
	public boolean return0MWD3()
	{
		return checkBox_true;
	}
	public boolean return2MWD3()
	{
